...
```console
$ ./pnstat.py -n enp6s0 -n enp1s0f0np0
...
```console
$ ./pnstat.py -n enp6s0 -n enp1s0f0np0 -j
...
```console
$ ./pnstat.py -n enp6s0 -n enp1s0f0np0 --keys witherrors
...
```console
$ ./pnstat.py -n enp6s0 -n enp1s0f0np0 --keys all
...
```console
$ ./pnstat.py -n enp6s0 -n enp1s0f0np0 --keys all -j
